...
!!! warning "Consignes"
    ...
    À partir des documents, expliquer sous la forme d'un schéma fonctionnel, les réactions du corps au niveau d'une blessure. Votre réponse devra mettre en évidence l'apparition des signes de la réactions inflammatoire et le processus de défense du corps.
