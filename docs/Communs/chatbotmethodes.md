...
Lien vers un chatboSt pour aider dans les fiches méthodes.

[chatbot](https://chatmd.forge.apps.education.fr/#https://forge.apps.education.fr/michael.dubois/chatbotmethodes/-/raw/main/chatbotmethodes.md?ref_type=heads)

Le chatbot est réalisé avec CHatMD de Cédric Eyssette.


# Outils d'aide en Sciences V5
...
Le dessin se fait au centre de la feuille on dessine l'objet observé ou une partie de façon assez grosse pour que le dessin soit lisible.
...
• Étape 2 : Tracer le REPÈRE avec les 2 axes gradués.  
...
4. Protocole : Étapes pour réaliser l'expérience, chaque étape contient un verbe d'action. L'expérience doit posséder deux tests minimum avec un seul paramètre.
5. Résultats attendus : Indiquer quel devrait être les résultats pour les tests si l'hypothèse est vraie.
...
6. La mise au point se fait avec les vis microscopique (les petites) à partir de l’objectif jaune (x10) et bleu (x40/x60)
