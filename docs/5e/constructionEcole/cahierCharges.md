...
Vous êtes responsable du projet de rénovation d’une salle de sciences. Vous allez devoir compélter votre cahier des charges d'après les textes de recommandations et proposer un croquis d'une salle de classe.

!!! warning "Consignes"
    Consigne 1 : Compléter le titre du document 4 et les titres des colonnes, en vous aidant du document 1.  
    Consigne 2 : Compélter le cahier des charges en retrouvant les  élements manquants.  
...
**Document 1 : Quelques définitions de technologie**
...
![Alt text](<Pictures/Diagramme fonctionnel T1.1.jpg>)
...
- Flexibilité de configuration pour un travail individuel et/ou collectif, avec suffisament de place pour une classe complète de 28 élèves.  
...
Pour la sécurité des usagers, une salle de classe et plus particulièrmebnt une salle de sciences , doit respecter quelques normes.
...
- Un extincteur doit être présent en permancence et facilement accessible.
