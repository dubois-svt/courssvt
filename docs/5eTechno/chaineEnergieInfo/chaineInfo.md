...
![Interrupteur](image-3.png){:style="width:150px;"} 

![Compteur de vitesse](image-4.png){:style="width:150px;"} 

![Sirène](image-5.png){:style="width:150px;"} 

![Clavier](image-6.png){:style="width:150px;"} 
</div>
<div markdown style="display:flex; flex-direction: row;">

![Station météo](image-7.png){:style="width:150px;"} 

![Ecran LED](image-8.png){:style="width:150px;"} 

![capteur ultrason](image-9.png){:style="width:150px;"} 
