...
## Séquence Les objets et les systèmes technologiques :
...
### activité : Faire la liste des interacteurs extérieurs d’un OST 
### activité : Repérer et expliquer les choix de conception dans les domainesde l’ergonomie et de la sécurité ou en lien avec des objectifs de développement durable 

## séquence  : Choix d’un OST et développement durable 
### activité : Repérer pour un OST les matériaux, les sources et les formes d’énergie, le traitement de l’information  
### activité : Identifier les étapes du cycle de vie d’un OST influencées parles choix de matériaux et d’énergie 
### activité : Choisir un OST parmi plusieurs propositions en vue de répondre à un besoin  (voiture électrique et thermique)
### activité 12 : Mesurer et comparer une performance d’un OST à partir d’un protocole fourni  (voiture télécommandée)

## séquence  : Fonctions, solutions, constituants de la chaine d’énergie + information 
### activité : Associer des solutions techniques à une ou des fonctions techniques + Identifier les principaux matériaux constitutif d’un OST 
### activité  : Identifier des constituants de la chaîne d’énergie d’un objet technique (l’organisation de la chaîne d’énergie étant fournie) + Indiquer la nature des énergies en entrée et en sortie des constituants de la chaîne d’énergie 
### activité : Identifier des constituants de la chaîne d’information d’un objet technique (l’organisation de la chaîne d’information étant fournie) 

## séquence  : La circulation de l’information dans un réseau informatique 
### activité  : Identifier les composants qui constituent un réseau local (terminaux, commutateurs, liaisons filaires et sans fil (WIFI)) et sa topologie + Justifier la nécessité d’identifier les terminaux pour communiquer sur un réseau local (activité débranchée et vérification par un outil de simulation) 

## séquence: Le dépannage et la réparation 
### activité : Repérer visuellement une pièce défectueuse + Réaliser une réparation en suivant un protocole fourni + Découvrir les procédés de réalisation présents dans un atelier de fabrication collaboratif

## séquence  : La programmation d’une nouvelle fonctionnalité 
### activité : Identifier les données utilisées et produites par le programme associé à une fonctionnalité d’un OST (à partir d’un programme existant)
### activité Comprendre et traduire en un algorithme en langage naturel le programme associé à une fonctionnalité d’un OST 
### activité :  Modifier les paramètre d’un programme et identifier ou évaluer ses effets en termes de fonctionnalité 

## séquence : La gestion de projet technique / Le prototypage de solution / Le choix d’une source d’énergie / L’assemblage de constituants / La modélisation et la fabrication / La validation du comportement mécanique d’un matériau
### activité : Suivre un processus de conception et de réalisation dans une durée, avec des tâches identifiées 
### activité : Fabriquer une solution pour améliorer un OST existant 
### activité : Choisir un matériaux parmi plusieurs proposés en fonction de leur caractéristiques 
### activité : Assembler les constituants fournis pour réaliser un prototype
### activité : Mettre en œuvre les moyens pour réaliser une forme selon une procédure fournie 

## séquence : La validation du comportement mécanique d’un matériaux / La validation des performance d’un OST 
### activité : Utiliser une simulation fournie pour valider la tenue mécanique d’un matériaux + mettre en œuvre un protocole de test fourni pour valider la tenue mécanique d’un matériau + vérifier le comportement et les performance d’un objet technique en suivant un protocole fourni

## séquence : La programmation des OST 
### activité  : Analyser un programme simple fourni et tester s’il répond au besoin ou au problème posé 
### activité  : Modifier un programme fourni pour répondre au besoin ou à un problème 
### activité : Réaliser et mettre au point un programme simple commandant un OST 
...
### Activité : Les caractères héréditaire
- trouver et utiliser des informations 
- Construire un tableau
...
## Séquence mouvements de la tectonique des plaques:
